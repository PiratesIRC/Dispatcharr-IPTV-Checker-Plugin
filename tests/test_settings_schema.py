...
FIELD_IDS = {
    ...
    'black_screen_min_black_seconds', 'black_screen_ffmpeg_timeout', '_section_post_check',
    ...
    'video_format_suffixes', '_section_restore', '_section_webhook', 'webhook_url',
    ...
    'scheduler_delete_dead_channels', 'auto_delete_confirmation', 'scheduler_fire_webhook',
